...
parser.add_argument('--dataset', type=str, default='OH', help='Dataset string: R8, R52, OH, 20NGnew, MR')
...
parser.add_argument('--embedding_file', type= str,help ="the folder containing the generated embedding")
